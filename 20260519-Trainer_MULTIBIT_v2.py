...
class WatermarkTrainer:
    ...
    def step_generator(self, batch, epoch: int, it: int) -> Dict[str, float]:
        ...
        # PATCH 2026-05-19: hard-clamp alpha (see synth_variants_nograd for rationale)
        ...
        if n_bad > 0:
            ...
            # PATCH 2026-05-19 (fix v2): use getattr() with default — robust against
            # _nan_counter_epoch being reset at epoch start before _nan_counter_total exists.
            self._nan_counter_epoch = int(getattr(self, "_nan_counter_epoch", 0)) + 1
            self._nan_counter_total = int(getattr(self, "_nan_counter_total", 0)) + 1
    ...
    def train(self) -> None:
        ...
        for epoch in range(1, self.cfg.epochs + 1):
            ...
            # PATCH 2026-05-19 (fix v2): reset per-epoch NaN counter, preserve total counter
            self._nan_counter_epoch = 0
            if not hasattr(self, "_nan_counter_total"):
