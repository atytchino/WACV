...
def parse_args() -> TrainConfig:
    ...
    ap.add_argument("--ctrl_leak_max", type=float, default=0.010, help="Leak threshold for the controller brake. If leak exceeds this, eps is reduced and the up-step is skipped. Was hardcoded 0.003; raise (e.g. 0.010-0.015) to let watermark strengthen.")
